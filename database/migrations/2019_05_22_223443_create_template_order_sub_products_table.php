...
class CreateTemplateOrderSubProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('template_order_sub_products', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('template_order_sub_products');
    }
}
